                ...
                <div className="flex flex-wrap gap-3 items-center justify-center mt-4 md:mt-0">
                    ...
                    >
                        ...
                        <option value="Légendes Brillantes">Légendes Brillantes</option>
                            <option value="Flammes Fantasmagoriques">Flammes Fantasmagoriques</option>
                        <option value="Couronne Stellaire">Couronne Stellaire</option>
                        <option value="Méga-Évolution">Méga-Évolution</option>
                            <option value="Promos Méga-Évolution">Promos Méga-Évolution</option>
                            ...
                            <option value="Mascarade Crépusculaire">Mascarade Crépusculaire</option>
                            <option value="Forces Temporelles">Forces Temporelles</option>
                            <option value="Destinées de Paldea">Destinées de Paldea</option>
                            ...
                            <option value="Promos Écarlate et Violet">Promos Écarlate et Violet</option>
                            ...
                            <option value="Destinées Radieuses">Destinées Radieuses</option>
                            ...
                            <option value="Promos Épée et Bouclier">Promos Épée et Bouclier</option>
                            ...
                            <option value="Majesté des Dragons">Majesté des Dragons</option>
                            ...
                            <option value="Promos Soleil et Lune">Promos Soleil et Lune</option>
                            ...
                            <option value="Promos X&Y">Promos X&Y</option>
                            ...
                            <option value="Promos Black Star HeartGold SoulSilver">Promos Black Star HeartGold SoulSilver</option>
                            <option value="Platine : Arceus">Platine : Arceus</option>
                            <option value="Platine : Vainqueurs Suprêmes">Platine : Vainqueurs Suprêmes</option>
                            <option value="Platine : Rivaux Émergeants">Platine : Rivaux Émergeants</option>
                            <option value="Platine">Platine</option>
                            <option value="Diamant & Perle : Tempête">Diamant & Perle : Tempête</option>
                            <option value="Diamant & Perle : Eveil des Légendes">Diamant & Perle : Eveil des Légendes</option>
                            <option value="Diamant & Perle : Aube Majestueuse">Diamant & Perle : Aube Majestueuse</option>
                            <option value="Diamant & Perle : Duels au Sommet">Diamant & Perle : Duels au Sommet</option>
                            <option value="Diamant & Perle : Merveilles Secrètes">Diamant & Perle : Merveilles Secrètes</option>
                            <option value="Diamant & Perle : Trésors Mystérieux">Diamant & Perle : Trésors Mystérieux</option>
                            <option value="Diamant & Perle">Diamant & Perle</option>
                            <option value="Promos Black Star DP">Promos Black Star DP</option>
                            <option value="Promos Black Star DP">Promos Black Star DP</option>
                            ...
                            <option value="Black Star Nintendo">Black Star Nintendo</option>
                            <option value="Black Star Nintendo">Black Star Nintendo</option>
                            ...
                            <option value="Promo Black Star Wizards Of The Coast">Promo Black Star Wizards Of The Coast</option>
                            <option value="Détective Pikachu">Détective Pikachu</option>
                            <option value="Promos Alternative">Promos Alternative</option>
